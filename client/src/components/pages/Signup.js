      ...
      <div className="container" id="container">
        <div className="form-container sign-up-container">
          <form action="#" className="signup">
            ...
            <input type="text" id="username" className="signup" placeholder="Name" />
            <input type="email" id="email" className="signup" placeholder="Email" />
            <input type="password" id="password" className="signup" placeholder="Password" />
        ...
        <div className="overlay-container">
          <div className="overlay">
            ...
            <div className="overlay-panel overlay-right">
              ...
              <p className="signup">
                Enter your personal details and start journey with to find your
                loved pet
              </p>
